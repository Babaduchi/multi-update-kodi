...
1. Clears the contents of Kodi's `special://temp/` cache and reports the total size deleted.
2. Clears downloaded add-on and build packages from `special://home/addons/packages/` and reports the total size deleted.
