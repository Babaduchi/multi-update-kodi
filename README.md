...
After step 3, a summary dialog reports the cache and installation-package sizes deleted and the PVR/EPG refresh result. Choose **Scan Libraries** to run steps 4-6, or **Exit Add-on** to stop after step 3.
